 ...
 * @version generated on Mon Aug 08 23:13:11 PKT 2016 by Bushra
 */
public class DefaultVerse extends WrappedIndividualImpl implements Verse {
    ...
    public Collection<? extends Integer> getChapterIndex() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_CHAPTERINDEX, Integer.class);
    }
    ...
    public void addChapterIndex(Integer newChapterIndex) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_CHAPTERINDEX, newChapterIndex);
    }

    public void removeChapterIndex(Integer oldChapterIndex) {
    ...
    public Collection<? extends Integer> getVerseIndex() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_VERSEINDEX, Integer.class);
    }
    ...
    public void addVerseIndex(Integer newVerseIndex) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_VERSEINDEX, newVerseIndex);
    }

    public void removeVerseIndex(Integer oldVerseIndex) {
